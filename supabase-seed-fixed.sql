-- Fixed seed data with proper UUIDs
-- Run this in Supabase SQL Editor

-- Insert sample businesses with valid UUIDs
INSERT INTO businesses (id, name, email, phone, subscription_status, event_count) VALUES
    ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Cape Town Markets Co.', 'paid@demo.com', '+27 21 424 0805', 'active', 2),
    ('b2c3d4e5-f6a7-8901-bcde-f23456789012', 'Joburg Events', 'free@demo.com', '+27 11 838 5678', 'free', 0);

-- Insert sample events with valid UUIDs
INSERT INTO events (
    ...
    (
        'e1b2c3d4-e5f6-7890-abcd-ef1234567891',
    ...
    (
        'e3b2c3d4-e5f6-7890-abcd-ef1234567893',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 1,
        'Greenside Morning Farmers Market',
    ...
    (
        'e4b2c3d4-e5f6-7890-abcd-ef1234567894',
    ...
    (
        'e5b2c3d4-e5f6-7890-abcd-ef1234567895',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 2,
        'Cape Town Art Fair Pop-Up',
    ...
    (
        'e6b2c3d4-e5f6-7890-abcd-ef1234567896',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 3,
        'Trail Run: Table Mountain Explorer',
    ...
    (
        'e7b2c3d4-e5f6-7890-abcd-ef1234567897',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 1,
        'Pretoria Night Market',
    ...
    (
        'e8b2c3d4-e5f6-7890-abcd-ef1234567898',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 1,
        'Maboneng Sunday Market',
    ...
    (
        'e9b2c3d4-e5f6-7890-abcd-ef1234567899',
    ...
    (
        'e10c3d4e5-f6a7-8901-bcde-f23456789013',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 3,
        'Joburg Craft Beer Festival',
    ...
    (
        'e11c3d4e5-f6a7-8901-bcde-f23456789014',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 2,
    ...
    (
        'e12c3d4e5-f6a7-8901-bcde-f23456789015',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 2,
